...
const termsText = `תנאי שימוש באפליקציה – Barbers Bar

ברוך הבא לאפליקציית ניהול התורים של Barbers Bar. השימוש באפליקציה מעיד על הסכמתך המלאה לתנאים אלו.
...
2. על האפליקציה
האפליקציה משמשת לניהול וזימון תורים לעסקים. היא מופעלת ומתוחזקת באופן עצמאי על-ידי Barbers Bar.
...
ייתכנו תקלות או זמינות מוגבלת. Barbers Bar אינו אחראי לנזק עקיף או ישיר.
...
7. קניין רוחני
כל הזכויות על העיצוב, הפיתוח והתוכן באפליקציה שייכות ל-Barbers Bar.
...
9. שינוי תנאים
Barbers Bar שומר לעצמו את הזכות לעדכן את תנאי השימוש ללא הודעה מוקדמת.
10. יצירת קשר
לשאלות או פניות:
✉️ orel895@gmail.com
📞 052-398-5505`;
